...
export function ir_builder(mod: Mod, songs: MusicTrack[], gameFolder: JSZip) {
  /*
  # MUSIC MOD CREATION TOOL (MMCT) for Imperator: Rome

  # This is a script that creates the required .txt file for your Imperator: Rome Music Mod based on the .ogg files passed into it.
...
function textDef(song: MusicTrack) {
  return `${song.key} = {
    music = "file:/music/${song.file.name}"
    weight = 15
    mood = yes
