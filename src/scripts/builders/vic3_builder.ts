...
export function vic3_builder(mod: Mod, songs: MusicTrack[], gameFolder: JSZip) {
  /*
  ...
  */
  ...
  songs.forEach((s) => {
    if (s.name !== "maintheme") {
      ...
      mainThemeFolder?.file(`${mod.filename}_maintheme.txt`, textDef(s));
      mainThemeFolder?.file(s.file.name, s.file);
    }
  });
