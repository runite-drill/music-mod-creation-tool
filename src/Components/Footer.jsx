...
export default function Footer() {
  return (
    <Card textAlign="center">
      ...
      <Card height={0} />
      <Text color="muted">
        <Link size={300} color="neutral" href="https://open.spotify.com/artist/0mfgyFocLTW5Piqx811ZUv">Spotify</Link>
        <Small> | </Small>
        <Link size={300} color="neutral" href="https://www.youtube.com/c/utopiamusic">Youtube</Link>
        <Small> | </Small>
        <Link size={300} color="neutral" href="https://steamcommunity.com/id/runite_drill/myworkshopfiles/">Steam</Link>
        <Small> | </Small>
        <Link size={300} color="neutral" href="https://utopiamusicnz.bandcamp.com">Bandcamp</Link>
        <Small> | </Small>
