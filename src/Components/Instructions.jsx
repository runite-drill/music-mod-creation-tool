  ...
  return (
    <Pane width={560} display="flex" flexDirection="column" justifyContent="center" border="default" elevation={1} padding={16}>
      ...
      <Pane display="flex" flexDirection="column">
        ...
        <StatusIndicator color="#720e13">Crusader Kings 3</StatusIndicator>
      ...
      <Text>When the tool has done its hard work, a button will appear for you to download a <Strong>.zip</Strong> file with a music folder that you can just copy into your mod.</Text>
      <Card height={8} />
